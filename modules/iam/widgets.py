...
class TabularPermissionsWidget(FilteredSelectMultiple):
    class Media:
        js = ("iam/assets/js/tabular_permissions.js",)

    def __init__(
        self, verbose_name, is_stacked, input_name="user_permissions", attrs=None, choices=(), permissions_list=None
    ):
        ...
        self.permissions = (
            permissions_list.values("id", "codename", "content_type_id").order_by("codename")
            if permissions_list
            else Permission.objects.all().values("id", "codename", "content_type_id").order_by("codename")
        )
    ...
    def render(self, name, value, attrs=None, renderer=None):
        ...
        for app in apps.get_app_configs():
            app_dict = {"verbose_name": force_text(app.verbose_name), "label": app.label, "models": OrderedDict()}
            ...
            for model_name in app.models:
                ...
                if model._meta.permissions:
                    ...
                    for codename, perm_name in model._meta.permissions:
                        ...
                        model_custom_permissions.append((codename, verbose_name, c_perm_id))
                ...
                ):  # and not {add_perm_id, change_perm_id, delete_perm_id} & excluded_perms:
