...
class TblTeampointsactivitylog(models.Model):
    ...
    teamid = models.ForeignKey('TblTeamscoach', models.DO_NOTHING, db_column='TeamID')  # Field name made lowercase.
    points = models.IntegerField(db_column='Points')  # Field name made lowercase.
    totalrankingpoints = models.IntegerField(db_column='TotalRankingPoints')  # Field name made lowercase.
    createdt = models.DateTimeField(db_column='CreateDT')  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'tbl_TeamPointsActivityLog'
